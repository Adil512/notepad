...
const FOOTER_I18N: Record<string, Partial<FooterLabels>> = {
  ...
  ko: {
    ...
    htmlEditor: "HTML 에디터",
    more: "빠른 링크",
    categoryWritingTools: "글쓰기 도구",
    categoryEditorTools: "에디터 도구",
    categoryTextAnalysisTools: "텍스트 분석 도구",
    categoryDeveloperTools: "개발자 도구",
    categoryExcelConverterTools: "Excel 변환 도구",
    categoryDocumentConverterTools: "문서 변환 도구",
    categoryDataConverterTools: "데이터 변환 도구",
    categoryTextUtilityTools: "텍스트 유틸리티 도구",
  },
