      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-20 pt-10 sm:px-6 sm:pt-12 lg:px-8">
        <header className="mx-auto max-w-3xl text-center lg:mx-0 lg:max-w-none lg:text-left">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-2.5 lg:justify-start">
            ...
            <Link
              href={(locale === "id" || locale === "ceb" || locale === "hr" || locale === "cs" || locale === "da" || locale === "nl" || locale === "et" || locale === "fj" || locale === "fi" || locale === "gl" || locale === "ka" || locale === "de") ? "/tools/writing" : L("/tools/writing")}
            ...
            <Link
              href={(locale === "id" || locale === "ceb" || locale === "hr" || locale === "cs" || locale === "da" || locale === "nl" || locale === "et" || locale === "fj" || locale === "fi" || locale === "gl" || locale === "ka" || locale === "de") ? "/tools/editors" : L("/tools/editors")}
              className="rounded-full border border-border/90 bg-background px-5 py-2.5 text-sm font-medium text-foreground shadow-sm transition hover:border-primary/30 hover:bg-muted/40"
            >
              {t.chips.editors}
            </Link>
            <Link
              href={(locale === "id" || locale === "ceb" || locale === "hr" || locale === "cs" || locale === "da" || locale === "nl" || locale === "et" || locale === "fj" || locale === "fi" || locale === "gl" || locale === "ka" || locale === "de") ? "/tools/text" : L("/tools/text")}
              className="rounded-full border border-border/90 bg-background px-5 py-2.5 text-sm font-medium text-foreground shadow-sm transition hover:border-primary/30 hover:bg-muted/40"
            >
              {t.chips.text}
            </Link>
            <Link
              href={(locale === "id" || locale === "ceb" || locale === "hr" || locale === "cs" || locale === "da" || locale === "nl" || locale === "et" || locale === "fj" || locale === "fi" || locale === "gl" || locale === "ka" || locale === "de") ? "/tools/dev-tools" : L("/tools/dev-tools")}
              className="rounded-full border border-border/90 bg-background px-5 py-2.5 text-sm font-medium text-foreground shadow-sm transition hover:border-primary/30 hover:bg-muted/40"
            >
              {t.chips.devTools}
            </Link>
            <Link
              href={(locale === "id" || locale === "ceb" || locale === "hr" || locale === "cs" || locale === "da" || locale === "nl" || locale === "et" || locale === "fj" || locale === "fi" || locale === "gl" || locale === "ka" || locale === "de") ? "/tools/excel" : L("/tools/excel")}
              className="rounded-full border border-border/90 bg-background px-5 py-2.5 text-sm font-medium text-foreground shadow-sm transition hover:border-primary/30 hover:bg-muted/40"
            >
              {t.chips.excel}
            </Link>
        ...
        >
          {categories.map((cat) => (
            <Link
              key={cat.href}
              href={(locale === "id" || locale === "ceb" || locale === "hr" || locale === "cs" || locale === "da" || locale === "nl" || locale === "et" || locale === "fj" || locale === "fi" || locale === "gl" || locale === "ka" || locale === "de") ? cat.href : L(cat.href)}
